...
#   net = nn.DataParallel(net)
    net = DDP(net, delay_allreduce=True) # device_ids=[0], find_unused_parameters=True, output_device=1) #find_unused_parameters=True -> for this error :  https://study-grow.tistory.com/entry/pytorch-%EC%97%90%EB%9F%AC-DistributedDataParallel-%EC%97%90%EB%9F%AC
